...
<section class="hero">
  ...
  <div class="hero-media"><figure>
    <img src="/assets/photos/exterior.jpg?v={V}" width="800" height="600" alt="トリオランドの園舎外観。通りに面した明るい入口" fetchpriority="high" decoding="async">
    <figcaption>トリオランドの園舎外観</figcaption>
  </figure></div>
</section>
  ...
  <div class="branch-grid">
    <div class="branch"><div class="content">
      ...
      <ul>
        ...
        <li>ブランクのある方も応募可能と案内されています</li>
        <li>実務経験が浅い方も応募可能と案内されています</li>
...
<section class="soft">
  ...
  <div class="table-scroll"><table class="spec">
    ...
    <tr><th>雇用形態・給与・待遇</th><td>公式の募集要項をご確認ください。<a href="{RECRUIT_URL}" target="_blank" rel="noopener">最新の募集要項はこちら</a></td></tr>
  </table></div>
</section>
...
<section class="tight">
  ...
  募集職種・雇用形態・給与・勤務時間・待遇などの条件は時期により変わります。このページでは<b>確認できていない条件を推測して掲載していません</b>。応募の際は必ず
...
FAQS = [
    ...
    ("給食はありますか？アレルギー対応は？",
     "両園とも自園調理の給食を提供しています。駒沢大学園ではアレルギー対応食にも対応していると案内されています。詳しいご相談は園までお問い合わせください。"),
    ("延長保育や一時保育はありますか？",
    ...
    ("持ち物で準備するものはありますか？",
     "駒沢大学園では、おむつ・着替え・布団カバーは保護者の方にご準備いただくと案内されています。詳細は見学時にご案内します。"),
    ("園見学はできますか？",
...
def page_faq():
    ...
    return head(
        ...
        "世田谷区の企業主導型保育園トリオランドへのよくある質問。対象年齢、開園時間、認可保育園との違い、年度途中の入園、給食・アレルギー対応、延長保育、園見学、保育士・保育補助の求人までまとめています。",
...
def main():
    ...
    write("/komazawa.html", page_nursery(
        ...
        "トリオランド駒沢大学園は、東京都世田谷区野沢2丁目にある企業主導型保育園です。東急田園都市線 駒沢大学駅から徒歩約6分、三軒茶屋駅からも徒歩圏内。生後57日目〜2歳児クラス、定員19名の少人数で、一人ひとりの育ちに合わせた保育を行っています。",
        [("駅から徒歩6分の通いやすさ", "駒沢大学駅から約550m。三軒茶屋駅、西太子堂駅からも徒歩圏内で、通勤途中の送迎がしやすい立地です。"),
         ("定員19名の少人数保育", "0歳児9名・1歳児7名・2歳児3名。園全体で一人ひとりの様子を把握できる規模です。"),
         ("自園調理・アレルギー対応", "園内の調理室で給食を用意します。アレルギー対応食にも対応していると案内されています。"),
         ("園庭あり・お散歩も", "園庭があり、天気の良い日は近隣の公園にも出かけます。"),
         ("理学療法士による勉強会", "発達運動学的なアプローチを基盤に、専門職から学ぶ機会を定期的に設けています。"),
         ("入園料0円／給食費は会費込み", "入園料は0円、給食費は会費に含まれると案内されています。おむつ・着替え・布団カバーは保護者の方にご準備いただきます。")],
